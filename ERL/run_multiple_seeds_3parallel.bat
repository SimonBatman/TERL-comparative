...
REM ========================================
REM ERL Multi-Seed Parallel Training Script (3 processes)
REM ========================================
...
REM Define seeds to use (space separated) - reduced to 3 for parallel execution
set SEEDS=0 1 7
...
REM ========================================
echo ========================================
echo ERL Multi-Seed Parallel Training Launcher (3 Processes)
echo ========================================
...
echo Parallel Processes: 3
echo ========================================
echo.

REM Confirm before proceeding
set /p confirm="Confirm to start 3 parallel experiments? (y/n): "
if /i not "%confirm%"=="y" (
...
echo Starting 3 parallel experiments...
echo.
...
echo.
echo ========================================
echo All 3 experiments have been started!
...
echo - After these complete, you can run seeds 10 and 100 separately
echo.
pause